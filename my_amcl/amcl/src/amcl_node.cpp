...
class AmclNode
{
  ...
  private:
    ...
    bool enableAmclCallback(std_srvs::Empty::Request& req,
                                    std_srvs::Empty::Response& res)
    ...
    ros::ServiceServer enable_amcl_srv_;
    ros::ServiceServer disable_amcl_srv_;
        ...
        first_reconfigure_call_(true)
{
  ...
  global_loc_srv_ = nh_.advertiseService("global_localization",
					 &AmclNode::globalLocalizationCallback,
                                         this);
  enable_amcl_srv_ = nh_.advertiseService("enable_amcl",
					 &AmclNode::enableAmclCallback,
                                         this);
  disable_amcl_srv_ = nh_.advertiseService("disable_amcl",
					 &AmclNode::disableAmclCallback,
                                         this);
...
AmclNode::enableAmclCallback(std_srvs::Empty::Request& req, std_srvs::Empty::Response& res){
  __enabled__=true;
}
AmclNode::disableAmclCallback(std_srvs::Empty::Request& req, std_srvs::Empty::Response& res){
  __enabled__=false;
}
